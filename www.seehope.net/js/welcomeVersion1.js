...
window.onload = function() {
	...
	function showLoading() {
		...
		for(var i = 0; i < arr.length; i++) {
			...
			objImg.src = 'img/welcomeVersion1/' + arr[i];
	...
	function workContent() {
		//oWorksContent2
		var data = [{
				img: 'img/welcomeVersion1/worksimg1.jpg',
				text: '测试文字，哈哈哈啊司法所地1'
			},
			{
				img: 'img/welcomeVersion1/worksimg2.jpg',
				text: '测试文字，哈哈哈啊司法所地2'
			},
			{
				img: 'img/welcomeVersion1/worksimg3.jpg',
				text: '测试文字，哈哈哈啊司法所地3'
			},
			{
				img: 'img/welcomeVersion1/worksimg4.jpg',
				text: '测试文字，哈哈哈啊司法所地4'
			}
		];
	...
	function courseContent() {
		//oCourseContent3
		var data = [{
				img: 'img/welcomeVersion1/binoli.png',
				text: '测试文字111'
			},
			{
				img: 'img/welcomeVersion1/bks.png',
				text: '测试文字222'
			},
			{
				img: 'img/welcomeVersion1/gu.png',
				text: '测试文字333'
			},
			{
				img: 'img/welcomeVersion1/hlx.png',
				text: '测试文字444'
			},
			{
				img: 'img/welcomeVersion1/binoli.png',
	...
	function showMusic() {
		...
		oMusic.onclick = function() {
			if(onoff) {
				this.style.background = 'url(img/welcomeVersion1/musicon.gif)';
				oAudio.play();
			} else {
				this.style.background = 'url(img/welcomeVersion1/musicoff.gif)';
				oAudio.pause();
			}
			onoff = !onoff;
		};
